...
In class, we used mostly the [Open Logic Project](https://builds.openlogicproject.org/content/propositional-logic/propositional-logic.pdf) as our reference. In the following, I will give a quick rundown of the most important concepts.
