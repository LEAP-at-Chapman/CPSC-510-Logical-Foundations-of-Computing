...
<html lang="en" data-content_root="../../../../" >
  ...
  <head>
    ...
    <title>vite ⚡ &#8212; Logical Foundations of Computing</title>
...
<link rel="preload" as="script" href="../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'playground/sudoku/node_modules/vite/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/LEAP-at-Chapman/CPSC-510-Logical-Foundations-of-Computing/issues/new?title=Issue%20on%20page%20%2Fplayground/sudoku/node_modules/vite/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../_sources/playground/sudoku/node_modules/vite/README.md" target="_blank"
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="vite">
<h1>vite ⚡<a class="headerlink" href="#vite" title="Link to this heading">#</a></h1>
<blockquote>
<div><p>Next Generation Frontend Tooling</p>
</div></blockquote>
<ul class="simple">
<li><p>💡 Instant Server Start</p></li>
<li><p>⚡️ Lightning Fast HMR</p></li>
<li><p>🛠️ Rich Features</p></li>
<li><p>📦 Optimized Build</p></li>
<li><p>🔩 Universal Plugin Interface</p></li>
<li><p>🔑 Fully Typed APIs</p></li>
</ul>
<p>Vite (French word for “fast”, pronounced <code class="docutils literal notranslate"><span class="pre">/vit/</span></code>) is a new breed of frontend build tool that significantly improves the frontend development experience. It consists of two major parts:</p>
<ul class="simple">
<li><p>A dev server that serves your source files over <a class="reference external" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules">native ES modules</a>, with <a class="reference external" href="https://vite.dev/guide/features.html">rich built-in features</a> and astonishingly fast <a class="reference external" href="https://vite.dev/guide/features.html#hot-module-replacement">Hot Module Replacement (HMR)</a>.</p></li>
<li><p>A <a class="reference external" href="https://vite.dev/guide/build.html">build command</a> that bundles your code with <a class="reference external" href="https://rollupjs.org">Rollup</a>, pre-configured to output highly optimized static assets for production.</p></li>
</ul>
<p>In addition, Vite is highly extensible via its <a class="reference external" href="https://vite.dev/guide/api-plugin.html">Plugin API</a> and <a class="reference external" href="https://vite.dev/guide/api-javascript.html">JavaScript API</a> with full typing support.</p>
<p><a class="reference external" href="https://vite.dev">Read the Docs to Learn More</a>.</p>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./playground/sudoku/node_modules/vite"
        },
